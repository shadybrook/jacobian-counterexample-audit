...
separate proved consequences from open directions and priority-sensitive
claims. Exact symbolic scripts accompany this note. This is an independent,
non-peer-reviewed audit and makes no claim of discovery or priority.
\end{abstract}
...
\]
using the regular reconstruction \eqref{eq:trec} on the complementary chart.
Thus simple projective roots are in bijection with affine preimages.
...
Vanishing, and Image conjectures \cite{zwart,gaussian,zhao,image}.
...
The repository verifies the determinant, collision, inverse identities,
discriminants, boundary parametrization, nonproper path, slice Jacobian, and
commuting inverse-Jacobian fields using exact symbolic arithmetic. These checks
